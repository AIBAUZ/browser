...
## AIBA Browser Updater

Updater distribution design and implementation files are documented in:

- [docs/updater/README.md](docs/updater/README.md)
- [docs/updater/IMPLEMENTATION_PLAN.md](docs/updater/IMPLEMENTATION_PLAN.md)

Release automation for update metadata:

- [.github/workflows/release-update-manifest.yml](.github/workflows/release-update-manifest.yml)
